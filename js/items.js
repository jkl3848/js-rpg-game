...
export const damage = () => {
  ...
  const uncommonItems = [
    ...
    },
    {
      ...
      desc: "",
      detailedDesc:
        "Deal extra damage equal to 2% (+1% per stack) of your coin",
    },
    {
      name: "rareCoin",
    ...
    },
    {
      ...
      desc: "Homemade",
      detailedDesc:
        "Gain 10% (+10% per stack) chance to inflict POISON on enemy",
    },
    // {
    //   name: "sneakers",
    ...
    // },
    {
      ...
      desc: "",
      detailedDesc:
        "Gain 10% (+10% per stack) chance to inflict BROKEN on enemy",
    },
    {
      name: "paddedArmor",
  ...
  function gainItem(specItem) {
    ...
    if (!item) {
      ...
      if (itemPoolNumber <= store.itemChance[0]) {
        itemPool = commonItems;
        type = "common";
      } else if (
        itemPoolNumber > store.itemChance[0] &&
        itemPoolNumber <= store.itemChance[0] + store.itemChance[1]
      ) {
        ...
        itemPoolNumber > store.itemChance[0] + store.itemChance[1] &&
        itemPoolNumber <=
          store.itemChance[0] + store.itemChance[1] + store.itemChance[2]
      ) {
        itemPool = rareItems;
        type = "rare";
      } else if (
